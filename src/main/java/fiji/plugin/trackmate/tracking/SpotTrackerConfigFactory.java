 ...
 *            factory.
 */
public interface SpotTrackerConfigFactory< C extends Configurator > extends SpotTrackerFactory, FactoryGenericConfig< C >
{
	...
	public default ConfigurationPanel getTrackerConfigurationPanel( final Model model )
	{
		...
		return new GenericConfigPanel( config );
	}
