...
public class SparseLAPOverlapTracker extends MultiThreadedBenchmarkAlgorithm implements SpotTracker, Cancelable
{
	...
	public SparseLAPOverlapTracker( final SpotCollection spots, final Map< String, Object > settings )
	{
		this.spots = spots;
	...
	public boolean process()
	{
		...
		final SparseLAPFrameToFrameOverlapTracker frameToFrameLinker = new SparseLAPFrameToFrameOverlapTracker( spots, ftfSettings );
