...
public class CloseGapsAction extends AbstractTMAction {
	...
	public static class Factory implements TrackMateActionFactory {
		...
		private static final String NAME = "Close gaps by introducing new spots";

		private static final String KEY = "CLOSE_GAPS";
		...
		private static final ImageIcon ICON = fiji.plugin.trackmate.gui.Icons.ORANGE_ASTERISK_ICON;
