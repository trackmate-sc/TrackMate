...
public class CropImgView< T extends Type< T >> implements Img< T >
{
	...
	public CropImgView( final RandomAccessible< T > source, final long[] min, final long[] max, final ImgFactory< T > factory )
	{
	...
	@Override
	public RandomAccess< T > randomAccess( final Interval ival )
	{
