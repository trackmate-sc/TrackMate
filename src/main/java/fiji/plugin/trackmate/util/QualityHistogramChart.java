...
public class QualityHistogramChart extends JPanel {
     ...
     * @param minBinNumber the minimal desired number of bins.
     * @param maxBinNumber the maximal desired number of bins.
    ...
    public void displayHistogram(final double[] values, final double threshold) {
        ...
        this.autoThreshold = HistogramUtils.otsuThreshold(values);
        if (values.length > 0) {
