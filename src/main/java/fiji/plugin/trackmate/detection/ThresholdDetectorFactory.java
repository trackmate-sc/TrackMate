...
import fiji.plugin.trackmate.gui.panels.detector.ThresholdDetectorConfigurationPanel;
...
public class ThresholdDetectorFactory< T extends RealType< T > & NativeType< T >> implements SpotDetectorFactory< T >
{
	...
	public static final String INFO_TEXT = "<html>"
			...
			+ "the (possbily simplified) contour of this region. In 3D, a spot is "
			+ "created for each region in its center with a volume equal to the "
			+ "region volume."
			+ "</html>";
