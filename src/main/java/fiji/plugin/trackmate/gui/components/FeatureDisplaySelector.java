...
import static fiji.plugin.trackmate.gui.displaysettings.DisplaySettings.TrackMateObject.*;

public class FeatureDisplaySelector {

    private static final List<String> FEATURES_WITHOUT_MIN_MAX = Arrays.asList(FeatureUtils.USE_UNIFORM_COLOR_KEY,
    ...
    public static final CategoryJComboBox<TrackMateObject, String> createComboBoxSelector(final Model model, final Settings settings) {
        ...
        for (final TrackMateObject category : categoriesIn) {
            ...
            final Map<String, String> featureKeys;
...
//            featureNames.putAll(featureKeys);
            ...
            switch (category) {
                case SPOTS:
                    ...
                    featureKeys = featureUtils.collectFeatureKeys(category, model, settings);
                    features.put(category, featureKeys.keySet());
                    featureNames.putAll(featureKeys);
