...
public class SpotMesh extends SpotBase
{
	...
	/**
	 * Exposes the mesh stored in this spot.
	 * <p>
	 * Don't modify the mesh, as it is used by the spot to compute its position
	 * and radius. If you need to modify it, make a copy first.
	 *
	 * @return the mesh.
	 */
