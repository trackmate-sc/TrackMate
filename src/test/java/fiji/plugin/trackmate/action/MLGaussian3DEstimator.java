 ...
 * ({@link Gaussian3D}.
 */
public class MLGaussian3DEstimator implements StartPointEstimator
{
	 ...
	 *            dimension).
	 */
	public MLGaussian3DEstimator( final double[] typicalSigmas )
	{
	...
	public double[] initializeFit( final Localizable point, final Observation data )
	{
		...
		final double[] startParam = new double[ 6 ];
		...
		startParam[ 4 ] = sigmas[ 0 ];
		startParam[ 5 ] = sigmas[ 2 ];
