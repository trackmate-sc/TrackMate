 ...
 * #L%
 */
package fiji.plugin.trackmate.tracking.kalmanFF;
...
import fiji.plugin.trackmate.tracking.kalman.KalmanTrackerFF;
import fiji.plugin.trackmate.visualization.hyperstack.HyperStackDisplayer;
import fiji.plugin.trackmate.visualization.trackscheme.TrackScheme;
import ij.ImageJ;

public class KalmanTrackerFFInteractiveTest
{
	...
	{
		ImageJ.main( args );
		final KalmanTrackerFFInteractiveTest tester = new KalmanTrackerFFInteractiveTest();
	...
	private Model test( final SpotCollection spots )
	{
		...
		final double initialSearchRadius = 2 * WIDTH / ( NFRAMES );
		final KalmanTrackerFF tracker = new KalmanTrackerFF( spots, maxSearchRadius, maxFrameGap, initialSearchRadius, null, null );
