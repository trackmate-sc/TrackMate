...
public class JonkerVolgenantAlgorithmSparse2Test
{
	...
	private SparseMatrix generateSparseMatrix( final double[][] weights )
	{
		...
		return new SparseMatrix( sources, targets, costs );
	}

	@Test
	public void speedTest()
	{
		final JonkerVolgenantAlgorithmSparse2 jvs = new JonkerVolgenantAlgorithmSparse2();
		...
		final SparseMatrix sparse = generateSparseMatrix( weights );
	...
	public final void testSparseIsNonSparse()
	{
		...
		final JonkerVolgenantAlgorithmSparse2 jvs = new JonkerVolgenantAlgorithmSparse2();
		final SparseMatrix CM = generateSparseMatrix( weights );
		...
		assertEquals( jvsSparse, jonkerVolgenantCost, 1e-5 );
	}
}
