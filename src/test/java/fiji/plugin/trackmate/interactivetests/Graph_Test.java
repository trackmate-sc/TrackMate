...
public class Graph_Test
{
	...
	public static final Model getExampleModel()
	{
		...
		final Spot root = new Spot( new double[] { 3d, 0d, 0d }, "Zygote" );

		final Spot AB = new Spot( new double[] { 0d, 1d, 0d }, "AB" );
		final Spot P1 = new Spot( new double[] { 3d, 1d, 0d }, "P1" );

		final Spot P2 = new Spot( new double[] { 4d, 2d, 0d }, "P2" );
		final Spot EMS = new Spot( new double[] { 2d, 2d, 0d }, "EMS" );

		final Spot P3 = new Spot( new double[] { 5d, 3d, 0d }, "P3" );
		final Spot C = new Spot( new double[] { 3d, 3d, 0d }, "C" );
		final Spot E = new Spot( new double[] { 1d, 3d, 0d }, "E" );
		final Spot MS = new Spot( new double[] { 2d, 3d, 0d }, "MS" );
		final Spot AB3 = new Spot( new double[] { 0d, 3d, 0d }, "AB" );

		final Spot D = new Spot( new double[] { 4d, 4d, 0d }, "D" );
		final Spot P4 = new Spot( new double[] { 5d, 4d, 0d }, "P4" );
	...
	public static final Model getComplicatedExample()
	{
		...
		{
			// new spots
			final Spot Q1 = model.addSpotTo( new Spot( new double[ 3 ], "Q1" ), 0 );
			final Spot Q2 = model.addSpotTo( new Spot( new double[ 3 ], "Q2" ), 1 );
			final Spot Q3 = model.addSpotTo( new Spot( new double[ 3 ], "Q3" ), 2 );
			// new links
