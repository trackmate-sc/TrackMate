...
% Jean-Yves Tinevez - 2016 - 2024
    ...
    % tic
    % EndNodes = arrayfun(@(id)spotIDMap(id), [sourceID targetID]);
    % toc;
    
    % tic;
    % EndNodes = edgeTable{:,{SPOT_SOURCE_ID_ATTRIBUTE SPOT_TARGET_ID_ATTRIBUTE}};
    % EndNodes = cell2mat(values(spotIDMap, num2cell(EndNodes)));
    % toc;
